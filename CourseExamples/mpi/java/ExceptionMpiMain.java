 ...
 *   mpijavac ExceptionMpiMain.java.java
 *
 * Usage:
 *   mpiexec [parameters] java [parameters] ExceptionMpiMain.java
 *
 * Examples:
 *   mpiexec java ExceptionMpiMain.java
 *   mpiexec java -cp $HOME/mpi_classfiles ExceptionMpiMain.java
 *
 *
 * File: ExceptionMpiMain.java.java		Author: S. Gross
 * Date: 09.09.2016
 *
 */
...
public class ExceptionMpiMain
{
						 ...
						 InterruptedException
  {
    ...
    try
    {
      ...
      MPI.COMM_WORLD.bcast (intValue, 1, MPI.INT, -1);
    }
