 ...
 * Compiling:
 *
 * cc  -xopenmp -o omp_fprintf_shared_iob omp_fprintf_shared_iob.c
 * gcc -fopenmp -o omp_fprintf_shared_iob omp_fprintf_shared_iob.c
 * icc -qopenmp -o omp_fprintf_shared_iob omp_fprintf_shared_iob.c
 * cl  /GL /Ox /openmp omp_fprintf_shared_iob.c
 *
 *
 * Running:
 *   ./omp_fprintf_shared_iob
 *
 *
 * File: omp_fprintf_shared_iob.c	Author: S. Gross
 * Date: 04.08.2017
 *
 */
...
int main (void)
{
  #pragma omp parallel default(none) shared(__iob)
