 ...
 *
 * This version uses OpenMP and the "atomic" directive.
 *
 ...
 *
 * Compiling:
 *   cc  -xopenmp -o pi_atomic pi_atomic.c [omp_stubs.c] [-lrt]
 *   gcc -fopenmp -o pi_atomic pi_atomic.c [omp_stubs.c] [-lrt]
 *   icc -qopenmp -o pi_atomic pi_atomic.c [omp_stubs.c]
 *   cl  /GL /Ox /openmp pi_atomic.c [omp_stubs.c]
 *
 * Running:
 *   ./pi_atomic [number of intervals]
 *
 *
 * File: pi_atomic.c			Author: S. Gross
 * Date: 04.08.2017
 *
 */
