 ...
 * Compiling:
 *
 * cc  -xopenmp -xloopinfo -xvpara -o omp_fprintf omp_fprintf.c
 * gcc -fopenmp -o omp_fprintf omp_fprintf.c
 * icc -qopenmp -o omp_fprintf omp_fprintf.c
 * cl  /GL /Ox /openmp omp_fprintf.c
 *
 *
 * Running:
 *   ./omp_fprintf
 *
 *
 * File: omp_fprintf.c			Author: S. Gross
 * Date: 04.08.2017
 *
 */
