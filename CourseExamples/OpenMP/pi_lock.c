 ...
 *
 * Compiling:
 *   cc  -xopenmp -o pi_lock pi_lock.c [omp_stubs.c] [-lrt]
 *   gcc -fopenmp -o pi_lock pi_lock.c [omp_stubs.c] [-lrt]
 *   icc -qopenmp -o pi_lock pi_lock.c [omp_stubs.c]
 *   cl  /GL /Ox /openmp pi_lock.c [omp_stubs.c]
 *
 * Running:
 *   ./pi_lock [number of intervals]
 *
 *
 * File: pi_lock.c			Author: S. Gross
 * Date: 04.08.2017
 *
 */
...
int main (int argc, char *argv[])
{
  ...
  h2 = h / 2;
  #pragma omp parallel default(none) private(i, x, fx)	\
