 ...
 * Compiling:
 *
 * cc  -xopenmp -o omp_fprintf_shared_stderr omp_fprintf_shared_stderr.c
 * gcc -fopenmp -o omp_fprintf_shared_stderr omp_fprintf_shared_stderr.c
 * icc -qopenmp -o omp_fprintf_shared_stderr omp_fprintf_shared_stderr.c
 * cl  /GL /Ox /openmp  omp_fprintf_shared_stderr.c
 *
 *
 * Running:
 *   ./ omp_fprintf_shared_stderr
 *
 *
 * File:  omp_fprintf_shared_stderr.c	Author: S. Gross
 * Date: 04.08.2017
 *
 */
