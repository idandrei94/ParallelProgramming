 ...
 * first element of the first row of "a" with the elements of the
 * first row of "b" to compute the first partial sums of the elements
 * of the first row of "c". Next it multiplies the second element of
 * the first row of "a" with the elements of the second row of "b" to
 ...
 *
 *
 * File: mat_mult_int_ikj.c		Author: S. Gross
 * Date: 04.08.2017
 *
 */
