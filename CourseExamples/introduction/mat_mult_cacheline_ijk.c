 ...
 * The algorithm multiplies the matrices in the "traditional" way,
 * i.e., multiplying and adding the elements of one row and one
 * column to determine one element of the result matrix "c".
 ...
 *
 *
 * File: mat_mult_cacheline_ijk.c	Author: S. Gross
 * Date: 07.08.2017
 *
 */
