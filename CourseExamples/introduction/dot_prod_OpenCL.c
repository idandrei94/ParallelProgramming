/* Compute the dot product of two vectors in parallel with OpenCL.
 *
 ...
 * Compiling:
 *   Linux:
 *     gcc -o dot_prod_OpenCL dot_prod_OpenCL.c errorCodes.c -lOpenCL
 *   Mac OS X:
 *	 Uses frameworks:
 *	   -framework OpenCL
 *	   -framework OpenGL -framework GLUT
 *     gcc -o dot_prod_OpenCL dot_prod_OpenCL.c errorCodes.c \
 *	   -framework OpenCL
 *   Windows:
 *     cl dot_prod_OpenCL.c errorCodes.c OpenCL.lib
 *
 * Running:
 *   ./dot_prod_OpenCL
 *
 *
 * File: dot_prod_OpenCL.c		Author: S. Gross
 * Date: 09.09.2017
 *
 */
