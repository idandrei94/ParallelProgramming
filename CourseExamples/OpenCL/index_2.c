 ...
 * Compiling:
 *   Linux:
 *     gcc -o index_2 index_2.c errorCodes.c -lOpenCL
 *   Mac OS X:
 *	 Uses frameworks:
 *	   -framework OpenCL
 *	   -framework OpenGL -framework GLUT
 *     gcc -o index_2 index_2.c errorCodes.c -framework OpenCL
 *   Windows:
 *     cl index_2.c errorCodes.c OpenCL.lib
 *
 * Running:
 *   ./index_2
 *
 *
 * File: index_2.c			Author: S. Gross
 * Date: 12.06.2017
 *
 */
