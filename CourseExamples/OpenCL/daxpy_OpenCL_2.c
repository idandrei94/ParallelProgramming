 ...
 * Compiling:
 *   Linux:
 *     gcc -o daxpy_OpenCL_2 daxpy_OpenCL_2.c errorCodes.c -lOpenCL
 *   Mac OS X:
 *	 Uses frameworks:
 *	   -framework OpenCL
 *	   -framework OpenGL -framework GLUT
 *     gcc -o daxpy_OpenCL_2 daxpy_OpenCL_2.c errorCodes.c \
 *	   -framework OpenCL
 *   Windows:
 *     cl daxpy_OpenCL_2.c errorCodes.c OpenCL.lib
 *
 * Running:
 *   ./daxpy_OpenCL_2
 *
 *
 * File: daxpy_OpenCL_2.c		Author: S. Gross
 * Date: 12.06.2017
 *
 */
...
#define FILENAME    "daxpyKernel.cl"
