 ...
 * Compiling:
 *   Linux:
 *     gcc -o index_1 index_1.c errorCodes.c -lOpenCL
 *   Mac OS X:
 *	 Uses frameworks:
 *	   -framework OpenCL
 *	   -framework OpenGL -framework GLUT
 *     gcc -o index_1 index_1.c errorCodes.c -framework OpenCL
 *   Windows:
 *     cl index_1.c errorCodes.c OpenCL.lib
 *
 * Running:
 *   ./index_1
 *
 *
 * File: index_1.c			Author: S. Gross
 * Date: 12.06.2017
 *
 */
...
int main (void)
{
  ...
  for (unsigned int platform = 0; platform < numPlatforms; ++platform)
  {
    ...
    if ((deviceOpenCL_MajorVersion - '0') == 1)
    {
