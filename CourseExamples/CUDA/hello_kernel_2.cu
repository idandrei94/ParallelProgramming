 ...
 * checks if the kernel launch was successful or not.
 *
 *
 * Compiling:
 *   nvcc -arch=sm_50 -o hello_kernel_2 hello_kernel_2.cu
 *   clang --cuda-gpu-arch=sm_50 -o hello_kernel_2 \
 *	   hello_kernel_2.cu -lcudart
 *
 * Running:
 *   ./hello_kernel_2
 *
 *
 * File: hello_kernel_2.cu		Author: S. Gross
 * Date: 14.02.2018
 *
 */
